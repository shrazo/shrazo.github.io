...
const Contact = () => {
    ...
    return (
        <Container fluid="md" className='section pt-5' id="contact">
            <Row>
                <Col>
                    <Card border="secondary" style={{ border: '0' }}>
                        <Card.Body>
                            <Card.Title as="h5" className="section-title">Contact</Card.Title>
                            <div className="border mb-3"></div>
                            <Card.Text as="div">
                                <Row>
                                    <Col sm={2}>Address:</Col>
                                    <Col sm={10}>CNNL, ECE, NUS</Col>
                                </Row>
                                <Row>
                                    <Col sm={2}>Email:</Col>
                                    <Col sm={10}>shrazo[at]nus.edu.sg, shrazo[at].ac.bd</Col>
                                </Row>
                                <Row>

                                    {links && <Col sm={12} className='d-flex justify-content-center my-3'>
